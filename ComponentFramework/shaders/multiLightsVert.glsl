...
layout(location = 3) uniform vec3 lightPosA;
layout(location = 4) uniform vec3 lightPosB;


layout(location = 0) out vec3 vertNormal;
layout(location = 1) out vec3 lightDirA;
layout(location = 2) out vec3 eyeDir; 
layout(location = 3) out vec2 texCoord; 
layout(location = 4) out vec3 lightDirB;
...
vertNormal = normalize(normalMatrix * vNormal);
    ...
    lightDirA = normalize((lightPosA) - vertPos); 
    lightDirB = normalize((lightPosB) - vertPos); 
